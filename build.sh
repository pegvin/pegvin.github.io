...
if [ "$CMD" = "clean" ]; then
	...
	bunx wrangler pages deploy $BUILD --project-name 0ptr --branch master --commit-dirty true --no-bundle # Deploy to Cloudflare Pages (Ensure Production Branch is Set: https://developers.cloudflare.com/pages/configuration/branch-build-controls/#production-branch-control)
	exit 0
